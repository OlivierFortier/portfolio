...
export default function AppercuTechnos({setRef}) {
  ...
  return (
    <section ref={refElem} className="px-4 py-8 sm:py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 lg:pb-8">
      ...
      <ul ref={refTrail}  className="text-blue-600 dark:text-blue-400 grid grid-cols-2 gap-5 row-gap-6 mb-10 sm:grid-cols-3 lg:grid-cols-6">
      ...
      <div ref={refSpring}  className="text-center">
        <Link href="/a-propos">
          <animated.a style={scaleIn} className="cursor-pointer inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white dark:hover:text-blue-900 transition duration-200 rounded shadow-md bg-blue-500 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-500 focus:shadow-outline focus:outline-none">
            En savoir plus
