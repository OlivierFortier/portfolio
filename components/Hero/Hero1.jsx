        ...
        <div className="max-w-xl mx-auto lg:max-w-screen-xl">
          <div className="mb-16 lg:max-w-lg lg:mb-0">
            ...
            <div className="flex items-center">
              <a
                href="/"
                className="bg-blue-700 inline-flex items-center justify-center h-12 px-6 mr-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md"
              >
                Get started
              </a>
              <a
