    ...
    <>
      ...
      <div className="max-w-xs mx-auto md:max-w-2xl lg:max-w-4xl xl:max-w-4xl">
        <section className="body-font py-8 sm:py-14">
          ...
          >
            <p>
              J’adore les belles interfaces et les expériences utilisateur
              fluides
            </p>
          </animated.div>
        </section>
        ...
        <section className="body-font py-8 pb-6 sm:py-14 sm:pt-0 sm:pb-8">
          ...
          <p className="px-4 text-lg mx-auto xl:max-w-4xl text-blue-500">
            ...
            pour le front-end. J’aime m’impliquer autant dans le DevOps, que
            dans le back-end, en passant par la gestion d’état front-end, ou
            bien encore l’accessibilité de l’expérience utilisateur.La cerise
            sur le gateau, j’adore aider les gens et agir à titre de mentor. Je
            me débrouille pas mal dans la gestion d’une équipe et la direction
            d’un projet !
          </p>
        </section>
