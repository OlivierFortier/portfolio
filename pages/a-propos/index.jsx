  ...
  return (
    <div className="max-w-xs mx-auto md:max-w-2xl lg:max-w-4xl xl:max-w-4xl">
      <section className="body-font py-8 sm:py-14">
        <h1 className="px-4 mb-6 md:mb-16 font-sans text-4xl font-bold tracking-tight text-blue-600 sm:text-6xl sm:leading-none">
          Qui suis-je?
        </h1>
      ...
      <section className="body-font py-8 sm:py-14">
        <h1 className="px-4 mb-6 md:mb-16 font-sans text-xl font-bold tracking-tight text-blue-600 sm:text-3xl sm:leading-none">
        ...
        <p className="px-4 text-lg mx-auto xl:max-w-4xl text-blue-500">
          ...
          le bakc-end, en passant par la gestion dՎtat front-end, ou bien
